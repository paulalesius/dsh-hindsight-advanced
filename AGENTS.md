...
synchronous recall anchored on the steer itself), against
...
8. **KV cache is a first-class concern.** Automatic recall runs once per
   ...
   steer itself; a step claim without a human message recalls nothing),
